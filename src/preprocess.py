...
if __name__ == "__main__":
    ...
    parser.add_argument('--in-dir', type=str, default="/home/ma-user/work/DPRNN-mindspore/debug",
                        help='Directory path of wsj0 including tr, cv and tt')
    parser.add_argument('--out-dir', type=str, default="/home/ma-user/work/DPRNN-mindspore/out_dir",
